...
var AdminLayoutComponent = class _AdminLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLayoutComponent, selectors: [["app-admin-layout"]], decls: 21, vars: 1, consts: [["contentId", "main-content"], ["id", "main-content", 1, "ion-page"], ["slot", "start"], ["slot", "end"], ["routerLink", "/admin/applicants/complaints"], ["name", "bell-outline"], ["color", "danger", 4, "ngIf"], ["color", "danger"]], template: function AdminLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var CaseListComponent = class _CaseListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonBadge, DatePipe], styles: ["\n\n/*# sourceMappingURL=case-list.css.map */"] });
};
(() => {
...
var UserFormComponent = class _UserFormComponent {
  ...
  }, dependencies: [CommonModule, NgIf, FormsModule, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, IonicModule, IonButton2, IonButtons2, IonContent2, IonHeader2, IonInput2, IonItem2, IonSelect2, IonSelectOption2, IonTitle2, IonToolbar2, SelectValueAccessorDirective, TextValueAccessorDirective, IonBackButton2, ReactiveFormsModule, FormGroupDirective, FormControlName], styles: ["\n\n/*# sourceMappingURL=user-form.css.map */"] });
};
(() => {
...
var AnnouncementListComponent = class _AnnouncementListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonicModule, IonButton2, IonButtons2, IonContent2, IonHeader2, IonIcon2, IonItem2, IonItemDivider2, IonLabel2, IonList2, IonSearchbar2, IonSpinner2, IonTitle2, IonToggle, IonToolbar2, BooleanValueAccessorDirective, TextValueAccessorDirective, RouterLinkDelegateDirective, SlicePipe, DatePipe], encapsulation: 2 });
};
(() => {
...
var AnnouncementFormComponent = class _AnnouncementFormComponent {
  ...
  }, dependencies: [CommonModule, NgIf, ReactiveFormsModule, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, IonicModule, IonButton2, IonButtons2, IonContent2, IonHeader2, IonItem2, IonSpinner2, IonTextarea2, IonTitle2, IonToggle, IonToolbar2, BooleanValueAccessorDirective, TextValueAccessorDirective, IonBackButton2], encapsulation: 2 });
};
(() => {
...
//# sourceMappingURL=chunk-IEZFZZ33.js.map
