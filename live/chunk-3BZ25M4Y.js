...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 17, vars: 0, consts: [[1, "w-64", "bg-black/30", "backdrop-blur-[20px]", "p-6", "flex", "flex-col", "text-white", "rounded-xl", "border", "border-white/10", "shadow-[0_8px_32px_0_rgba(31,38,135,0.37)]"], [1, "text-2xl", "font-bold", "mb-10", "text-center"], [1, "mb-4"], ["routerLink", "/admin/dashboard", "routerLinkActive", "bg-white/20", 1, "flex", "items-center", "p-3", "rounded-lg", "hover:bg-white/10", "transition-colors", "duration-200"], [1, "fas", "fa-tachometer-alt", "w-6", "h-6", "mr-3"], ["routerLink", "/admin/employees", "routerLinkActive", "bg-white/20", 1, "flex", "items-center", "p-3", "rounded-lg", "hover:bg-white/10", "transition-colors", "duration-200"], [1, "fas", "fa-users", "w-6", "h-6", "mr-3"], [1, "mt-auto"], [1, "w-full", "flex", "items-center", "justify-center", "p-3", "rounded-lg", "bg-red-600/80", "hover:bg-red-700/80", "transition-colors", "duration-200", 3, "click"], [1, "fas", "fa-sign-out-alt", "w-6", "h-6", "mr-3"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var AdminLayoutComponent = class _AdminLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLayoutComponent, selectors: [["app-admin-layout"]], decls: 5, vars: 0, consts: [[1, "flex", "h-screen", "p-8", "bg-transparent"], [1, "flex-1", "overflow-y-auto"], [1, "w-full", "h-full", "bg-white/20", "backdrop-blur-[20px]", "rounded-xl", "shadow-lg", "p-8", "text-white", "border", "border-white/10", "shadow-[0_8px_32px_0_rgba(31,38,135,0.37)]"]], template: function AdminLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminLayoutComponent, [{
    type: Component,
    args: [{ selector: "app-admin-layout", standalone: true, imports: [RouterModule, SidebarComponent], template: '<div class="flex h-screen p-8 bg-transparent">\n  <app-sidebar></app-sidebar>\n  <main class="flex-1 overflow-y-auto">\n    <div class="w-full h-full bg-white/20 backdrop-blur-[20px] rounded-xl shadow-lg p-8 text-white border border-white/10 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)]">\n      <router-outlet></router-outlet>\n    </div>\n  </main>\n</div>\n' }]
  }], null, null);
})();
(() => {
...
//# sourceMappingURL=chunk-3BZ25M4Y.js.map
