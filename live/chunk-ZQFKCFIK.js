...
var AdminDashboardComponent = class _AdminDashboardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminDashboardComponent, selectors: [["app-admin-dashboard"]], decls: 7, vars: 0, consts: [[1, "w-full", "h-full", "bg-white/10", "backdrop-blur-lg", "rounded-xl", "shadow-lg", "p-8", "text-white"], [1, "text-4xl", "font-bold", "mb-4"], [1, "text-lg"]], template: function AdminDashboardComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmployeeListComponent, [{
    type: Component,
    args: [{ selector: "app-employee-list", standalone: true, imports: [CommonModule, FormsModule, RouterModule], template: `<div class="w-full h-full bg-white/10 backdrop-blur-lg rounded-xl shadow-lg p-8 text-white">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmployeeFormComponent, [{
    type: Component,
    args: [{ selector: "app-employee-form", standalone: true, imports: [CommonModule, FormsModule, RouterModule], template: `<div class="w-full h-full bg-white/10 backdrop-blur-lg rounded-xl shadow-lg p-8 text-white">
...
//# sourceMappingURL=chunk-ZQFKCFIK.js.map
