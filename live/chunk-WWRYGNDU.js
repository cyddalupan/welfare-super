...
var AdminLoginComponent = class _AdminLoginComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLoginComponent, selectors: [["app-admin-login"]], decls: 16, vars: 3, consts: [[1, "flex", "items-center", "justify-center", "h-screen", "w-screen"], [1, "w-full", "max-w-md", "bg-white/10", "backdrop-blur-lg", "rounded-xl", "shadow-lg", "p-8", "text-white"], [1, "text-3xl", "font-bold", "text-center", "mb-8"], [3, "ngSubmit"], [1, "mb-4"], ["for", "email", 1, "block", "text-sm", "font-medium", "mb-2"], ["type", "email", "id", "email", "name", "email", "placeholder", "admin@example.com", "required", "", 1, "w-full", "px-4", "py-2", "bg-white/20", "rounded-md", "border", "border-transparent", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", 3, "ngModelChange", "ngModel"], [1, "mb-6"], ["for", "password", 1, "block", "text-sm", "font-medium", "mb-2"], ["type", "password", "id", "password", "name", "password", "placeholder", "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", "required", "", 1, "w-full", "px-4", "py-2", "bg-white/20", "rounded-md", "border", "border-transparent", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", 3, "ngModelChange", "ngModel"], ["type", "submit", 1, "w-full", "bg-blue-600", "hover:bg-blue-700", "text-white", "font-bold", "py-2", "px-4", "rounded-md", "transition", "duration-300"], ["class", "mt-4 text-red-400 text-center", 4, "ngIf"], [1, "mt-4", "text-red-400", "text-center"]], template: function AdminLoginComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var AdminDashboardComponent = class _AdminDashboardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminDashboardComponent, selectors: [["app-admin-dashboard"]], decls: 7, vars: 0, consts: [[1, "text-white"], [1, "text-4xl", "font-bold", "mb-4"], [1, "text-lg"]], template: function AdminDashboardComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var EmployeeListComponent = class _EmployeeListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmployeeListComponent, selectors: [["app-employee-list"]], decls: 25, vars: 3, consts: [[1, "container", "mx-auto", "text-white"], [1, "flex", "justify-between", "items-center", "mb-6"], [1, "text-3xl", "font-bold"], ["routerLink", "/admin/employees/new", 1, "bg-blue-600", "hover:bg-blue-700", "text-white", "font-bold", "py-2", "px-4", "rounded-md", "transition", "duration-300"], [1, "mb-4"], ["type", "text", "placeholder", "Search employees...", 1, "w-full", "px-4", "py-2", "bg-white/20", "rounded-md", "border", "border-transparent", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", 3, "ngModelChange", "input", "ngModel"], [1, "overflow-x-auto", "bg-black/30", "backdrop-blur-xl", "rounded-lg", "shadow-lg"], [1, "min-w-full"], [1, "border-b", "border-white/20"], [1, "px-6", "py-3", "text-left", "text-sm", "font-medium", "uppercase", "tracking-wider", "cursor-pointer", 3, "click"], [1, "px-6", "py-3", "text-right", "text-sm", "font-medium", "uppercase", "tracking-wider"], ["class", "border-b border-white/10 hover:bg-white/5", 4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "border-b", "border-white/10", "hover:bg-white/5"], [1, "px-6", "py-4", "whitespace-nowrap"], [1, "px-2", "inline-flex", "text-xs", "leading-5", "font-semibold", "rounded-full", 3, "ngClass"], [1, "px-6", "py-4", "whitespace-nowrap", "text-right", "text-sm", "font-medium"], [1, "text-indigo-400", "hover:text-indigo-300", "mr-4", 3, "routerLink"], [1, "text-red-400", "hover:text-red-300", 3, "click"], ["colspan", "5", 1, "text-center", "py-8"]], template: function EmployeeListComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmployeeListComponent, [{
    type: Component,
    args: [{ selector: "app-employee-list", standalone: true, imports: [CommonModule, FormsModule, RouterModule], template: `<div class="container mx-auto text-white">
...
var EmployeeFormComponent = class _EmployeeFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmployeeFormComponent, selectors: [["app-employee-form"]], decls: 88, vars: 16, consts: [["employeeForm", "ngForm"], [1, "container", "mx-auto", "text-white"], [1, "text-3xl", "font-bold", "mb-6"], [3, "ngSubmit"], [1, "bg-black/30", "backdrop-blur-xl", "rounded-lg", "shadow-lg", "p-6", "mb-6"], [1, "text-xl", "font-semibold", "mb-4", "border-b", "border-white/20", "pb-2"], [1, "grid", "grid-cols-1", "md:grid-cols-3", "gap-6"], [1, "form-group"], ["for", "first_name"], ["type", "text", "id", "first_name", "name", "first_name", "required", "", 3, "ngModelChange", "ngModel"], ["for", "middle_name"], ["type", "text", "id", "middle_name", "name", "middle_name", 3, "ngModelChange", "ngModel"], ["for", "last_name"], ["type", "text", "id", "last_name", "name", "last_name", "required", "", 3, "ngModelChange", "ngModel"], ["for", "passport_number"], ["type", "text", "id", "passport_number", "name", "passport_number", 3, "ngModelChange", "ngModel"], ["for", "date_of_birth"], ["type", "date", "id", "date_of_birth", "name", "date_of_birth", 3, "ngModelChange", "ngModel"], ["for", "country"], ["type", "text", "id", "country", "name", "country", 3, "ngModelChange", "ngModel"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-6"], ["for", "email"], ["type", "email", "id", "email", "name", "email", 3, "ngModelChange", "ngModel"], ["for", "phone_number"], ["type", "text", "id", "phone_number", "name", "phone_number", 3, "ngModelChange", "ngModel"], ["for", "whatsapp"], ["type", "text", "id", "whatsapp", "name", "whatsapp", 3, "ngModelChange", "ngModel"], ["for", "facebook"], ["type", "url", "id", "facebook", "name", "facebook", 3, "ngModelChange", "ngModel"], [1, "form-group", "md:col-span-2"], ["for", "address"], ["id", "address", "name", "address", "rows", "3", 3, "ngModelChange", "ngModel"], ["for", "main_status"], ["id", "main_status", "name", "main_status", 3, "ngModelChange", "ngModel"], ["for", "applicant_type"], ["id", "applicant_type", "name", "applicant_type", 3, "ngModelChange", "ngModel"], ["for", "date_deployment"], ["type", "date", "id", "date_deployment", "name", "date_deployment", 3, "ngModelChange", "ngModel"], [1, "flex", "justify-end", "items-center", "mt-8"], ["routerLink", "/admin/employees", 1, "text-gray-300", "hover:text-white", "mr-6"], ["type", "submit", 1, "bg-blue-600", "hover:bg-blue-700", "text-white", "font-bold", "py-2", "px-6", "rounded-md", "transition", "duration-300", "disabled:opacity-50", "disabled:cursor-not-allowed", 3, "disabled"]], template: function EmployeeFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmployeeFormComponent, [{
    type: Component,
    args: [{ selector: "app-employee-form", standalone: true, imports: [CommonModule, FormsModule, RouterModule], template: `<div class="container mx-auto text-white">
    ...
    <div class="bg-black/30 backdrop-blur-xl rounded-lg shadow-lg p-6 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="form-group">
          ...
          <input type="text" id="first_name" name="first_name" [(ngModel)]="employee.first_name" required>
        </div>
        <div class="form-group">
          <label for="middle_name">Middle Name</label>
          <input type="text" id="middle_name" name="middle_name" [(ngModel)]="employee.middle_name">
        </div>
        <div class="form-group">
          <label for="last_name">Last Name</label>
          <input type="text" id="last_name" name="last_name" [(ngModel)]="employee.last_name" required>
        </div>
        <div class="form-group">
          <label for="passport_number">Passport Number</label>
          <input type="text" id="passport_number" name="passport_number" [(ngModel)]="employee.passport_number">
        </div>
        <div class="form-group">
          <label for="date_of_birth">Date of Birth</label>
          <input type="date" id="date_of_birth" name="date_of_birth" [(ngModel)]="employee.date_of_birth">
        </div>
        <div class="form-group">
          <label for="country">Country</label>
          <input type="text" id="country" name="country" [(ngModel)]="employee.country">
        </div>
      </div>
    </div>
    ...
    <div class="bg-black/30 backdrop-blur-xl rounded-lg shadow-lg p-6 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="form-group">
          ...
          <input type="text" id="phone_number" name="phone_number" [(ngModel)]="employee.phone_number">
        </div>
        <div class="form-group">
          <label for="whatsapp">WhatsApp</label>
          <input type="text" id="whatsapp" name="whatsapp" [(ngModel)]="employee.whatsapp">
        </div>
        <div class="form-group">
          <label for="facebook">Facebook URL</label>
          <input type="url" id="facebook" name="facebook" [(ngModel)]="employee.facebook">
        </div>
        <div class="form-group md:col-span-2">
          <label for="address">Address</label>
          <textarea id="address" name="address" [(ngModel)]="employee.address" rows="3"></textarea>
        </div>
      </div>
    </div>
    ...
    <div class="bg-black/30 backdrop-blur-xl rounded-lg shadow-lg p-6 mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="form-group">
          ...
          <select id="main_status" name="main_status" [(ngModel)]="employee.main_status">
        ...
        <div class="form-group">
          ...
          <select id="applicant_type" name="applicant_type" [(ngModel)]="employee.applicant_type">
        ...
        <div class="form-group">
          ...
          <input type="date" id="date_deployment" name="date_deployment" [(ngModel)]="employee.date_deployment">
        </div>
      </div>
    </div>
...
//# sourceMappingURL=chunk-WWRYGNDU.js.map
