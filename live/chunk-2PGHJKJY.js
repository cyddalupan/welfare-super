...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SidebarComponent, [{
    type: Component,
    args: [{ selector: "app-sidebar", standalone: true, imports: [RouterModule, CommonModule, IonList, IonListHeader, IonLabel, IonMenuToggle, IonItem, IonIcon, IonFooter, IonToolbar, IonButton], template: `<ion-list>
  <ion-list-header>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminLayoutComponent, { className: "AdminLayoutComponent", filePath: "src/app/admin/layouts/admin-layout/admin-layout.ts", lineNumber: 30 });
})();
...
var ApplicantListComponent = class _ApplicantListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ApplicantListComponent, selectors: [["app-employee-list"]], decls: 12, vars: 3, consts: [["slot", "end"], ["routerLink", "/admin/applicants/new"], [1, "fa-solid", "fa-plus"], ["placeholder", "Search applicants...", 3, "ngModelChange", "ionChange", "ngModel"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [3, "click"], [1, "fa-solid", "fa-arrows-up-down"], [1, "ion-text-right"], [4, "ngFor", "ngForOf"], ["slot", "end", 3, "color"], ["fill", "clear", 3, "routerLink"], [1, "fa-solid", "fa-pen-to-square"], ["fill", "clear", "color", "danger", 3, "click", 4, "ngIf"], ["fill", "clear", "color", "primary", 3, "routerLink", 4, "ngIf"], ["target", "_blank", "rel", "noopener noreferrer", 3, "href"], [1, "fa-solid", "fa-file-lines"], ["fill", "clear", "color", "danger", 3, "click"], [1, "fa-solid", "fa-trash"], ["fill", "clear", "color", "primary", 3, "routerLink"], [1, "fa-solid", "fa-comments"], [1, "ion-text-center"]], template: function ApplicantListComponent_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonBadge], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ApplicantListComponent, [{
    type: Component,
    args: [{ selector: "app-employee-list", standalone: true, imports: [CommonModule, FormsModule, RouterModule, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonBadge], template: `<ion-header>
  <ion-toolbar>
...
var CaseListComponent = class _CaseListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CaseListComponent, selectors: [["app-case-list"]], decls: 12, vars: 3, consts: [["slot", "end"], ["routerLink", "/admin/cases/new"], [1, "fa-solid", "fa-plus"], ["placeholder", "Search cases...", 3, "ngModelChange", "ionChange", "ngModel"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [3, "click"], [1, "fa-solid", "fa-arrows-up-down"], [1, "ion-text-right"], [4, "ngFor", "ngForOf"], ["slot", "end", 3, "color"], ["fill", "clear", 3, "routerLink"], [1, "fa-solid", "fa-pen-to-square"], ["fill", "clear", "color", "danger", 3, "click", 4, "ngIf"], ["fill", "clear", "color", "danger", 3, "click"], [1, "fa-solid", "fa-trash"], [1, "ion-text-center"]], template: function CaseListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-title");
      \u0275\u0275text(3, "Cases");
      \u0275\u0275elementEnd();
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonBadge, DatePipe], styles: ["\n\n/*# sourceMappingURL=case-list.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CaseListComponent, [{
    type: Component,
    args: [{ selector: "app-case-list", standalone: true, imports: [CommonModule, FormsModule, RouterModule, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonBadge], template: `<ion-header>
  <ion-toolbar>
...
var FraListComponent = class _FraListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FraListComponent, selectors: [["app-fra-list"]], decls: 12, vars: 3, consts: [["slot", "end"], ["routerLink", "/admin/fras/new"], [1, "fa-solid", "fa-plus"], ["placeholder", "Search FRAs...", 3, "ngModelChange", "ionChange", "ngModel"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [3, "click"], [1, "fa-solid", "fa-arrows-up-down"], [1, "ion-text-right"], [4, "ngFor", "ngForOf"], ["fill", "clear", 3, "routerLink"], [1, "fa-solid", "fa-pen-to-square"], ["fill", "clear", "color", "danger", 3, "click", 4, "ngIf"], ["fill", "clear", "color", "danger", 3, "click"], [1, "fa-solid", "fa-trash"], [1, "ion-text-center"]], template: function FraListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-title");
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FraListComponent, [{
    type: Component,
    args: [{ selector: "app-fra-list", standalone: true, imports: [CommonModule, FormsModule, RouterModule, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem], template: `<ion-header>
  <ion-toolbar>
...
var ReferralListComponent = class _ReferralListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReferralListComponent, selectors: [["app-referral-list"]], decls: 12, vars: 3, consts: [["slot", "end"], ["routerLink", "/admin/referrals/new"], [1, "fa-solid", "fa-plus"], ["placeholder", "Search Referrals...", 3, "ngModelChange", "ionChange", "ngModel"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [3, "click"], [1, "fa-solid", "fa-arrows-up-down"], [1, "ion-text-right"], [4, "ngFor", "ngForOf"], ["fill", "clear", 3, "routerLink"], [1, "fa-solid", "fa-pen-to-square"], ["fill", "clear", "color", "danger", 3, "click", 4, "ngIf"], ["fill", "clear", "color", "danger", 3, "click"], [1, "fa-solid", "fa-trash"], [1, "ion-text-center"]], template: function ReferralListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-title");
      \u0275\u0275text(3, "Referrals");
      \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ReferralListComponent, [{
    type: Component,
    args: [{ selector: "app-referral-list", standalone: true, imports: [CommonModule, FormsModule, RouterModule, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem], template: `<ion-header>
  <ion-toolbar>
...
var UserListComponent = class _UserListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListComponent, selectors: [["app-user-list"]], decls: 14, vars: 3, consts: [["slot", "start"], ["slot", "end"], [3, "click"], [1, "fa-solid", "fa-plus-circle"], [1, "ion-padding"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [4, "ngFor", "ngForOf"], [1, "fa-solid", "fa-pen-to-square"], ["color", "danger", 3, "click", 4, "ngIf"], ["color", "danger", 3, "click"], [1, "fa-solid", "fa-trash"], [1, "ion-text-center"]], template: function UserListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-buttons", 0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserListComponent, { className: "UserListComponent", filePath: "src/app/admin/pages/user-list/user-list.ts", lineNumber: 34 });
})();
...
var UserFormComponent = class _UserFormComponent {
  ...
  }, dependencies: [CommonModule, NgIf, FormsModule, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, ReactiveFormsModule, FormGroupDirective, FormControlName, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonContent, IonItem, IonInput, IonSelect, IonSelectOption, IonButton], styles: ["\n\n/*# sourceMappingURL=user-form.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UserFormComponent, [{
    type: Component,
    args: [{ selector: "app-user-form", standalone: true, imports: [CommonModule, FormsModule, ReactiveFormsModule, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonContent, IonItem, IonInput, IonSelect, IonSelectOption, IonButton], template: `<ion-header>
  <ion-toolbar>
    <ion-buttons slot="start">
...
var AnnouncementListComponent = class _AnnouncementListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AnnouncementListComponent, selectors: [["app-announcement-list"]], decls: 12, vars: 3, consts: [["slot", "end"], ["routerLink", "/admin/announcements/new"], [1, "fa-solid", "fa-plus"], ["placeholder", "Search announcements...", 3, "ngModelChange", "ionChange", "ngModel"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [3, "click"], [1, "fa-solid", "fa-arrows-up-down"], [1, "ion-text-right"], [4, "ngFor", "ngForOf"], [3, "ionChange", "checked", "disabled"], ["fill", "clear", 3, "routerLink"], [1, "fa-solid", "fa-pen-to-square"], ["fill", "clear", "color", "danger", 3, "click", 4, "ngIf"], ["fill", "clear", "color", "danger", 3, "click"], [1, "fa-solid", "fa-trash"], [1, "ion-text-center"]], template: function AnnouncementListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-title");
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonToggle, SlicePipe, DatePipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AnnouncementListComponent, [{
    type: Component,
    args: [{ selector: "app-announcement-list", standalone: true, imports: [CommonModule, FormsModule, RouterModule, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonToggle], template: `<ion-header>
  <ion-toolbar>
...
var AnnouncementFormComponent = class _AnnouncementFormComponent {
  ...
  }, dependencies: [CommonModule, NgIf, ReactiveFormsModule, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonContent, IonItem, IonTextarea, IonToggle, IonButton, IonSpinner], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AnnouncementFormComponent, [{
    type: Component,
    args: [{ selector: "app-announcement-form", standalone: true, imports: [CommonModule, ReactiveFormsModule, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonContent, IonItem, IonTextarea, IonToggle, IonButton, IonSpinner], template: `<ion-header>
  <ion-toolbar>
    <ion-buttons slot="start">
...
function ApplicantComplaintsListComponent_ion_list_7_ion_item_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "ion-badge", 9);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "ion-buttons", 10)(11, "ion-button", 11);
    \u0275\u0275element(12, "i", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, ApplicantComplaintsListComponent_ion_list_7_ion_item_16_ion_button_13_Template, 2, 0, "ion-button", 13)(14, ApplicantComplaintsListComponent_ion_list_7_ion_item_16_ion_button_14_Template, 2, 3, "ion-button", 14);
...
function ApplicantComplaintsListComponent_ion_list_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-list")(1, "ion-item-divider")(2, "ion-label", 5);
    ...
    \u0275\u0275element(13, "i", 6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "ion-label", 7);
    \u0275\u0275text(15, "Actions");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(16, ApplicantComplaintsListComponent_ion_list_7_ion_item_16_Template, 17, 13, "ion-item", 8)(17, ApplicantComplaintsListComponent_ion_list_7_ion_item_17_Template, 3, 0, "ion-item", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var ApplicantComplaintsListComponent = class _ApplicantComplaintsListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ApplicantComplaintsListComponent, selectors: [["app-applicant-complaints-list"]], decls: 8, vars: 3, consts: [["placeholder", "Search applicants...", 3, "ngModelChange", "ionChange", "ngModel"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [3, "click"], [1, "fa-solid", "fa-arrows-up-down"], [1, "ion-text-right"], [4, "ngFor", "ngForOf"], ["slot", "end", 3, "color"], ["slot", "end"], ["fill", "clear", 3, "routerLink"], [1, "fa-solid", "fa-pen-to-square"], ["fill", "clear", "color", "danger", 3, "click", 4, "ngIf"], ["fill", "clear", "color", "primary", 3, "routerLink", 4, "ngIf"], ["target", "_blank", "rel", "noopener noreferrer", 3, "href"], [1, "fa-solid", "fa-file-lines"], ["fill", "clear", "color", "danger", 3, "click"], [1, "fa-solid", "fa-trash"], ["fill", "clear", "color", "primary", 3, "routerLink"], [1, "fa-solid", "fa-comments"], [1, "ion-text-center"]], template: function ApplicantComplaintsListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(6, ApplicantComplaintsListComponent_div_6_Template, 4, 0, "div", 1)(7, ApplicantComplaintsListComponent_ion_list_7_Template, 18, 2, "ion-list", 2);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonicModule, IonBadge2, IonButton2, IonButtons2, IonContent2, IonHeader2, IonItem2, IonItemDivider2, IonLabel2, IonList2, IonSearchbar2, IonSpinner2, IonTitle2, IonToolbar2, TextValueAccessorDirective, RouterLinkDelegateDirective], encapsulation: 2 });
};
(() => {
...
//# sourceMappingURL=chunk-2PGHJKJY.js.map
