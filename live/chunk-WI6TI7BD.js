...
var EmployeeService = class _EmployeeService {
  ...
  mapEmployeeToParams(employee) {
    return [
      ...
      employee.email || null,
      employee.is_support || false,
      // Assuming default should be false for a boolean
      employee.token || null,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmployeeFormComponent, [{
    type: Component,
    args: [{ selector: "app-employee-form", standalone: true, imports: [CommonModule, FormsModule, RouterModule], template: `<div class="glass-card w-full p-8">
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6">
        ...
        <div class="form-group">
          ...
          <input type="text" id="country" name="country" [(ngModel)]="employee.country" class="form-field">
        </div>
      </div>
    </div>
...
//# sourceMappingURL=chunk-WI6TI7BD.js.map
