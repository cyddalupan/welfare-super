...
function SidebarComponent_ion_list_14_ion_menu_toggle_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-menu-toggle", 0)(1, "ion-item", 21);
...
function SidebarComponent_ion_list_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-list")(1, "ion-menu-toggle", 0)(2, "ion-item", 18);
    \u0275\u0275element(3, "ion-icon", 19);
    \u0275\u0275elementStart(4, "ion-label");
    \u0275\u0275text(5, "All Applicants");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(6, SidebarComponent_ion_list_14_ion_menu_toggle_6_Template, 6, 6, "ion-menu-toggle", 20);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 41, vars: 3, consts: [["autoHide", "false"], ["routerLink", "/admin/dashboard", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "apps"], ["button", "", 3, "click"], ["slot", "start", "name", "people"], ["slot", "end", 3, "name"], [4, "ngIf"], ["routerLink", "/admin/cases", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "folder-open"], ["routerLink", "/admin/fras", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "business"], ["routerLink", "/admin/referrals", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "people-outline"], ["routerLink", "/admin/announcements", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "megaphone-outline"], ["autoHide", "false", 4, "ngIf"], ["expand", "full", "color", "danger", 3, "click"], ["slot", "start", "name", "log-out"], ["routerLink", "/admin/applicants", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "list"], ["autoHide", "false", 4, "ngFor", "ngForOf"], ["routerLinkActive", "selected", "routerDirection", "root", "detail", "false", 3, "routerLink"], ["slot", "start", "name", "person"], ["routerLink", "/admin/users", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "people-circle-outline"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementStart(36, "ion-footer")(37, "ion-toolbar")(38, "ion-button", 16);
      \u0275\u0275listener("click", function SidebarComponent_Template_ion_button_click_38_listener() {
        return ctx.logout();
      });
      \u0275\u0275element(39, "ion-icon", 17);
      \u0275\u0275text(40, " Logout ");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
...
function ApplicantListComponent_ion_list_11_ion_item_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, ApplicantListComponent_ion_list_11_ion_item_16_ion_button_13_Template, 2, 0, "ion-button", 15);
    \u0275\u0275elementStart(14, "a", 16);
    \u0275\u0275element(15, "ion-icon", 17);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(10, _c02, app_r4.id));
    \u0275\u0275advance(2);
...
function ApplicantListComponent_ion_list_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15, "Actions");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(16, ApplicantListComponent_ion_list_11_ion_item_16_Template, 16, 12, "ion-item", 11)(17, ApplicantListComponent_ion_list_11_ion_item_17_Template, 3, 0, "ion-item", 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function FraFormComponent_form_10_ion_select_option_74_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-select-option", 44);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const applicant_r3 = ctx.$implicit;
    \u0275\u0275property("value", applicant_r3.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", applicant_r3.first_name, " ", applicant_r3.last_name, " ");
  }
}
function FraFormComponent_form_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "ion-item")(9, "ion-select", 12);
    \u0275\u0275twoWayListener("ngModelChange", function FraFormComponent_form_10_Template_ion_select_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.fra.country, $event) || (ctx_r1.fra.country = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(10, "ion-select-option", 13);
    \u0275\u0275text(11, "Select Country");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "ion-select-option", 14);
    \u0275\u0275text(13, "United States");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "ion-select-option", 15);
    \u0275\u0275text(15, "Canada");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "ion-select-option", 16);
    \u0275\u0275text(17, "Mexico");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(21, "United Kingdom");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "ion-select-option", 19);
    \u0275\u0275text(23, "France");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "ion-select-option", 20);
    \u0275\u0275text(25, "Germany");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "ion-select-option", 21);
    \u0275\u0275text(27, "Italy");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "ion-select-option", 22);
    \u0275\u0275text(29, "Spain");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "ion-select-option", 23);
    \u0275\u0275text(31, "China");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "ion-select-option", 24);
    \u0275\u0275text(33, "India");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "ion-select-option", 25);
    \u0275\u0275text(35, "Japan");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "ion-select-option", 26);
    \u0275\u0275text(37, "South Korea");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "ion-select-option", 27);
    \u0275\u0275text(39, "Australia");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "ion-select-option", 28);
    \u0275\u0275text(41, "New Zealand");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "ion-select-option", 29);
    \u0275\u0275text(43, "Philippines");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "ion-select-option", 30);
    \u0275\u0275text(45, "Saudi Arabia");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "ion-select-option", 31);
    \u0275\u0275text(47, "United Arab Emirates");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "ion-select-option", 32);
    \u0275\u0275text(49, "Qatar");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "ion-select-option", 33);
    \u0275\u0275text(51, "Kuwait");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "ion-select-option", 34);
    \u0275\u0275text(53, "Bahrain");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "ion-select-option", 35);
    \u0275\u0275text(55, "Oman");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "ion-select-option", 36);
    \u0275\u0275text(57, "Egypt");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "ion-select-option", 37);
    \u0275\u0275text(59, "Jordan");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "ion-select-option", 38);
    \u0275\u0275text(61, "Lebanon");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "ion-select-option", 39);
    \u0275\u0275text(63, "Iraq");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "ion-select-option", 40);
    \u0275\u0275text(65, "Iran");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "ion-select-option", 41);
    \u0275\u0275text(67, "Turkey");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "ion-select-option", 42);
    \u0275\u0275text(69, "Israel");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(70, "ion-item")(71, "ion-select", 43);
    \u0275\u0275twoWayListener("ngModelChange", function FraFormComponent_form_10_Template_ion_select_ngModelChange_71_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.fra.applicant_id, $event) || (ctx_r1.fra.applicant_id = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(72, "ion-select-option", 44);
    \u0275\u0275text(73, "Select Applicant");
    \u0275\u0275elementEnd();
    \u0275\u0275template(74, FraFormComponent_form_10_ion_select_option_74_Template, 2, 3, "ion-select-option", 45);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(75, "ion-item")(76, "ion-input", 46);
    \u0275\u0275twoWayListener("ngModelChange", function FraFormComponent_form_10_Template_ion_input_ngModelChange_76_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(77, "div", 47)(78, "ion-button", 48);
    \u0275\u0275listener("click", function FraFormComponent_form_10_Template_ion_button_click_78_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(79, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "ion-button", 49);
    \u0275\u0275text(81);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(62);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.fra.applicant_id);
    \u0275\u0275advance();
    \u0275\u0275property("value", null);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r1.applicants);
...
var FraFormComponent = class _FraFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FraFormComponent, selectors: [["app-fra-form"]], decls: 11, vars: 3, consts: [["slot", "start"], ["defaultHref", "/admin/fras"], [1, "ion-padding"], ["class", "ion-text-center ion-padding", 4, "ngIf"], [3, "ngSubmit", 4, "ngIf"], [1, "ion-text-center", "ion-padding"], ["name", "crescent"], [3, "ngSubmit"], ["lines", "full"], ["label", "Name", "type", "text", "name", "name", "required", "", 3, "ngModelChange", "ngModel"], ["label", "Contact Person", "type", "text", "name", "contact", "required", "", 3, "ngModelChange", "ngModel"], ["label", "Address", "rows", "3", "name", "address", "required", "", 3, "ngModelChange", "ngModel"], ["label", "Country", "name", "country", "required", "", 3, "ngModelChange", "ngModel"], ["value", ""], ["value", "US"], ["value", "CA"], ["value", "MX"], ["value", "BR"], ["value", "GB"], ["value", "FR"], ["value", "DE"], ["value", "IT"], ["value", "ES"], ["value", "CN"], ["value", "IN"], ["value", "JP"], ["value", "KR"], ["value", "AU"], ["value", "NZ"], ["value", "PH"], ["value", "SA"], ["value", "AE"], ["value", "QA"], ["value", "KW"], ["value", "BH"], ["value", "OM"], ["value", "EG"], ["value", "JO"], ["value", "LB"], ["value", "IQ"], ["value", "IR"], ["value", "TR"], ["value", "IL"], ["label", "Applicant", "name", "applicant_id", 3, "ngModelChange", "ngModel"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], ["label", "Agency ID", "type", "number", "name", "agency_id", 3, "ngModelChange", "ngModel"], [1, "ion-padding-top", "ion-text-right"], ["fill", "clear", 3, "click"], ["type", "submit"]], template: function FraFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-buttons", 0);
      \u0275\u0275element(3, "ion-back-button", 1);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(6, "ion-content", 2)(7, "ion-card")(8, "ion-card-content");
      \u0275\u0275template(9, FraFormComponent_div_9_Template, 4, 0, "div", 3)(10, FraFormComponent_form_10_Template, 82, 9, "form", 4);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, RouterModule, IonicModule, IonButton, IonButtons, IonCard, IonCardContent, IonContent, IonHeader, IonInput, IonItem, IonList, IonSelect, IonSelectOption, IonSpinner, IonTextarea, IonTitle, IonToolbar, NumericValueAccessorDirective, SelectValueAccessorDirective, TextValueAccessorDirective, IonBackButton, ReactiveFormsModule], encapsulation: 2 });
};
(() => {
    ...
    <ion-card-content>
      ...
      <form *ngIf="!isLoading" (ngSubmit)="saveFra()">
        <ion-list lines="full">
          ...
          <ion-item>
            <ion-select label="Country" [(ngModel)]="fra.country" name="country" required>
              <ion-select-option value="">Select Country</ion-select-option>
              <ion-select-option value="US">United States</ion-select-option>
              <ion-select-option value="CA">Canada</ion-select-option>
              <ion-select-option value="MX">Mexico</ion-select-option>
          ...
          <ion-item>
            <ion-select label="Applicant" [(ngModel)]="fra.applicant_id" name="applicant_id">
              <ion-select-option [value]="null">Select Applicant</ion-select-option>
              <ion-select-option *ngFor="let applicant of applicants" [value]="applicant.id">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FraFormComponent, { className: "FraFormComponent", filePath: "src/app/admin/components/fra-form/fra-form.ts", lineNumber: 18 });
})();
...
function ReferralFormComponent_form_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "ion-list", 8)(2, "ion-item")(3, "ion-input", 9);
    \u0275\u0275twoWayListener("ngModelChange", function ReferralFormComponent_form_10_Template_ion_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.referral.name, $event) || (ctx_r1.referral.name = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "ion-item")(5, "ion-input", 10);
    \u0275\u0275twoWayListener("ngModelChange", function ReferralFormComponent_form_10_Template_ion_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.referral.contact, $event) || (ctx_r1.referral.contact = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "ion-item")(7, "ion-input", 11);
    \u0275\u0275twoWayListener("ngModelChange", function ReferralFormComponent_form_10_Template_ion_input_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.referral.referred_by, $event) || (ctx_r1.referral.referred_by = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "div", 12)(9, "ion-button", 13);
    \u0275\u0275listener("click", function ReferralFormComponent_form_10_Template_ion_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.referral.name);
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.referral.contact);
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.referral.referred_by);
    \u0275\u0275advance(5);
...
var ReferralFormComponent = class _ReferralFormComponent {
  ...
  async saveReferral() {
    try {
      if (this.isEditMode && this.referralId) {
        await this.referralService.updateReferral(__spreadProps(__spreadValues({}, this.referral), { id: this.referralId }));
      } else {
        await this.referralService.createReferral(this.referral);
      }
      this.router.navigate(["/admin/referrals"]);
    } catch (error) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReferralFormComponent, selectors: [["app-referral-form"]], decls: 11, vars: 3, consts: [["slot", "start"], ["defaultHref", "/admin/referrals"], [1, "ion-padding"], ["class", "ion-text-center ion-padding", 4, "ngIf"], [3, "ngSubmit", 4, "ngIf"], [1, "ion-text-center", "ion-padding"], ["name", "crescent"], [3, "ngSubmit"], ["lines", "full"], ["label", "Name", "type", "text", "name", "name", "required", "", 3, "ngModelChange", "ngModel"], ["label", "Contact", "type", "text", "name", "contact", "required", "", 3, "ngModelChange", "ngModel"], ["label", "Referred By", "type", "text", "name", "referred_by", "required", "", 3, "ngModelChange", "ngModel"], [1, "ion-padding-top", "ion-text-right"], ["fill", "clear", 3, "click"], ["type", "submit"]], template: function ReferralFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-buttons", 0);
      \u0275\u0275element(3, "ion-back-button", 1);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(6, "ion-content", 2)(7, "ion-card")(8, "ion-card-content");
      \u0275\u0275template(9, ReferralFormComponent_div_9_Template, 4, 0, "div", 3)(10, ReferralFormComponent_form_10_Template, 13, 4, "form", 4);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
  ...
  }, dependencies: [CommonModule, NgIf, FormsModule, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, RouterModule, IonicModule, IonButton, IonButtons, IonCard, IonCardContent, IonContent, IonHeader, IonInput, IonItem, IonList, IonSpinner, IonTitle, IonToolbar, TextValueAccessorDirective, IonBackButton], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ReferralFormComponent, [{
    type: Component,
    args: [{ selector: "app-referral-form", standalone: true, imports: [CommonModule, FormsModule, RouterModule, IonicModule], template: `<ion-header>
  <ion-toolbar>
    <ion-buttons slot="start">
...
<ion-content class="ion-padding">
  <ion-card>
    <ion-card-content>
      ...
      <form *ngIf="!isLoading" (ngSubmit)="saveReferral()">
        <ion-list lines="full">
          <ion-item>
            <ion-input label="Name" type="text" [(ngModel)]="referral.name" name="name" required></ion-input>
          </ion-item>

          <ion-item>
            <ion-input label="Contact" type="text" [(ngModel)]="referral.contact" name="contact" required></ion-input>
          </ion-item>

          <ion-item>
            <ion-input label="Referred By" type="text" [(ngModel)]="referral.referred_by" name="referred_by" required></ion-input>
          </ion-item>
        </ion-list>

        <div class="ion-padding-top ion-text-right">
          <ion-button fill="clear" (click)="router.navigate(['/admin/referrals'])">Cancel</ion-button>
          <ion-button type="submit">{{ isEditMode ? 'Update Referral' : 'Create Referral' }}</ion-button>
        </div>
      </form>
    </ion-card-content>
  </ion-card>
...
var UserFormComponent = class _UserFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserFormComponent, selectors: [["app-user-form"]], decls: 22, vars: 6, consts: [["slot", "start"], ["defaultHref", "/admin/users"], [1, "ion-padding"], [3, "ngSubmit"], ["label", "Full Name", "type", "text", "name", "full_name", "required", "", 3, "ngModelChange", "ngModel"], ["label", "Email", "type", "email", "name", "email", "required", "", 3, "ngModelChange", "ngModel"], ["label", "Password", "type", "password", "name", "password", 3, "ngModelChange", "ngModel", "required"], ["label", "User Type", "name", "user_type", 3, "ngModelChange", "ngModel"], ["value", "admin"], ["value", "staff"], ["expand", "block", "type", "submit", 1, "ion-margin-top"]], template: function UserFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-buttons", 0);
      \u0275\u0275element(3, "ion-back-button", 1);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementStart(8, "ion-item")(9, "ion-input", 4);
      \u0275\u0275twoWayListener("ngModelChange", function UserFormComponent_Template_ion_input_ngModelChange_9_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.user.full_name, $event) || (ctx.user.full_name = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "ion-item")(11, "ion-input", 5);
      \u0275\u0275twoWayListener("ngModelChange", function UserFormComponent_Template_ion_input_ngModelChange_11_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.user.email, $event) || (ctx.user.email = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(12, "ion-item")(13, "ion-input", 6);
      \u0275\u0275twoWayListener("ngModelChange", function UserFormComponent_Template_ion_input_ngModelChange_13_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.user.password, $event) || (ctx.user.password = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "ion-item")(15, "ion-select", 7);
      \u0275\u0275twoWayListener("ngModelChange", function UserFormComponent_Template_ion_select_ngModelChange_15_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.user.user_type, $event) || (ctx.user.user_type = $event);
        return $event;
      });
      \u0275\u0275elementStart(16, "ion-select-option", 8);
      \u0275\u0275text(17, "Admin");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "ion-select-option", 9);
      \u0275\u0275text(19, "Staff");
      \u0275\u0275elementEnd()()();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("required", !ctx.isEdit);
      \u0275\u0275advance(2);
      \u0275\u0275twoWayProperty("ngModel", ctx.user.user_type);
    }
  }, dependencies: [CommonModule, FormsModule, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, IonicModule, IonButton, IonButtons, IonContent, IonHeader, IonInput, IonItem, IonSelect, IonSelectOption, IonTitle, IonToolbar, SelectValueAccessorDirective, TextValueAccessorDirective, IonBackButton], styles: ["\n\n/*# sourceMappingURL=user-form.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UserFormComponent, [{
    type: Component,
    args: [{ selector: "app-user-form", standalone: true, imports: [CommonModule, FormsModule, IonicModule], template: `<ion-header>
  <ion-toolbar>
    <ion-buttons slot="start">
...
<ion-content class="ion-padding">
  <form (ngSubmit)="saveUser()">
    <ion-item>
      <ion-input label="Full Name" type="text" [(ngModel)]="user.full_name" name="full_name" required></ion-input>
    </ion-item>
    <ion-item>
      <ion-input label="Email" type="email" [(ngModel)]="user.email" name="email" required></ion-input>
    </ion-item>
    <ion-item>
      <ion-input label="Password" type="password" [(ngModel)]="user.password" name="password" [required]="!isEdit"></ion-input>
    </ion-item>
    <ion-item>
      <ion-select label="User Type" [(ngModel)]="user.user_type" name="user_type">
        <ion-select-option value="admin">Admin</ion-select-option>
        <ion-select-option value="staff">Staff</ion-select-option>
      </ion-select>
    </ion-item>
    <ion-button expand="block" type="submit" class="ion-margin-top">Save User</ion-button>
  </form>
</ion-content>
...
//# sourceMappingURL=chunk-FDM2IQTJ.js.map
