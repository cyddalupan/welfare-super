...
var AdminLayoutComponent = class _AdminLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLayoutComponent, selectors: [["app-admin-layout"]], decls: 5, vars: 0, consts: [[1, "flex", "h-screen", "p-8", "bg-transparent"], [1, "flex-1", "overflow-y-auto"], [1, "w-full", "h-full", "bg-white/30", "backdrop-blur-[30px]", "rounded-xl", "shadow-lg", "p-8", "text-white"]], template: function AdminLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-DWEVTNNY.js.map
