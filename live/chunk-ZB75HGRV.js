...
function ApplicantListComponent_ion_list_11_ion_item_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", app_r4.main_status === "with_complain");
    \u0275\u0275advance();
  ...
  <ion-list *ngIf="!isLoading">
    ...
    <ion-item *ngFor="let app of filteredApplicants">
      ...
      <ion-buttons slot="end">
        ...
        <ion-button *ngIf="app.main_status === 'with_complain'" [routerLink]="['/admin/manual-chat', app.id]" fill="clear" color="primary">
...
var ManualChatComponent = class _ManualChatComponent {
  ...
  sendMessage() {
    ...
    const adminMessage = { role: "assistant", content: this.newMessage.trim() };
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ManualChatComponent, selectors: [["app-manual-chat"]], viewQuery: function ManualChatComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "ion-footer")(11, "ion-toolbar")(12, "div", 7)(13, "ion-textarea", 8, 1);
...
//# sourceMappingURL=chunk-ZB75HGRV.js.map
