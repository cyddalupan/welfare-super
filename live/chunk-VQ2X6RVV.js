...
function AdminLayoutComponent_ion_badge_20_Template(rf, ctx) {
  if (rf & 1) {
...
var AdminLayoutComponent = class _AdminLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLayoutComponent, selectors: [["app-admin-layout"]], decls: 23, vars: 1, consts: [["contentId", "main-content"], ["id", "main-content", 1, "ion-page"], ["slot", "start"], ["slot", "end"], ["routerLink", "/admin/applicants/status/RESOLVED"], [1, "fa-solid", "fa-check"], ["routerLink", "/admin/applicants/complaints"], [1, "fa-regular", "fa-bell"], ["color", "danger", 4, "ngIf"], ["color", "danger"]], template: function AdminLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(19, "i", 7);
      \u0275\u0275template(20, AdminLayoutComponent_ion_badge_20_Template, 2, 1, "ion-badge", 8);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(21, "ion-content");
      \u0275\u0275element(22, "ion-router-outlet");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(20);
...
var ApplicantListComponent = class _ApplicantListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonBadge], styles: ["\n\nion-searchbar[_ngcontent-%COMP%] {\n  --background: rgba(255, 255, 255, 0.1);\n  --color: var(--ion-text-color);\n  --placeholder-color: rgba(var(--ion-text-color-rgb), 0.7);\n  --border-radius: 10px;\n  border: 1px solid var(--ion-color-step-300);\n  box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);\n  margin: 10px;\n}\n@media (prefers-color-scheme: dark) {\n  ion-searchbar[_ngcontent-%COMP%] {\n    --background: rgba(0, 0, 0, 0.2);\n  }\n}\n.applicant-list-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  padding: 0.5rem 1rem;\n  background: var(--ion-item-background, var(--ion-background-color));\n  border-bottom: 1px solid var(--ion-color-step-150);\n}\nion-item.applicant-list-row[_ngcontent-%COMP%] {\n  --background-hover: rgba(var(--ion-color-primary-rgb), 0.1);\n  --background-focused: rgba(var(--ion-color-primary-rgb), 0.15);\n}\nion-item-divider.applicant-list-row[_ngcontent-%COMP%]   div[_ngcontent-%COMP%], \nion-item.applicant-list-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%] {\n  flex: 1;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.col-name[_ngcontent-%COMP%], \n.col-passport[_ngcontent-%COMP%], \n.col-country[_ngcontent-%COMP%], \n.col-status[_ngcontent-%COMP%] {\n  flex: 2;\n}\n.col-actions[_ngcontent-%COMP%] {\n  flex: 1.5;\n  text-align: right;\n}\nion-item[_ngcontent-%COMP%]   .applicant-info[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%], \nion-item[_ngcontent-%COMP%]   .applicant-info[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.applicant-actions[_ngcontent-%COMP%]   ion-button[_ngcontent-%COMP%] {\n  margin-left: 0.5rem;\n  --padding-end: 0;\n  --padding-start: 0;\n}\n.applicant-actions[_ngcontent-%COMP%]   ion-button[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 1.2em;\n}\n.applicant-actions[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  margin-left: 0.5rem;\n  color: var(--ion-color-primary);\n  font-size: 1.2em;\n  display: flex;\n  align-items: center;\n}\n/*# sourceMappingURL=applicant-list.css.map */"] });
};
(() => {
...
`, styles: ["/* src/app/admin/pages/applicant-list/applicant-list.css */\nion-searchbar {\n  --background: rgba(255, 255, 255, 0.1);\n  --color: var(--ion-text-color);\n  --placeholder-color: rgba(var(--ion-text-color-rgb), 0.7);\n  --border-radius: 10px;\n  border: 1px solid var(--ion-color-step-300);\n  box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);\n  margin: 10px;\n}\n@media (prefers-color-scheme: dark) {\n  ion-searchbar {\n    --background: rgba(0, 0, 0, 0.2);\n  }\n}\n.applicant-list-row {\n  display: flex;\n  align-items: center;\n  padding: 0.5rem 1rem;\n  background: var(--ion-item-background, var(--ion-background-color));\n  border-bottom: 1px solid var(--ion-color-step-150);\n}\nion-item.applicant-list-row {\n  --background-hover: rgba(var(--ion-color-primary-rgb), 0.1);\n  --background-focused: rgba(var(--ion-color-primary-rgb), 0.15);\n}\nion-item-divider.applicant-list-row div,\nion-item.applicant-list-row ion-label {\n  flex: 1;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.col-name,\n.col-passport,\n.col-country,\n.col-status {\n  flex: 2;\n}\n.col-actions {\n  flex: 1.5;\n  text-align: right;\n}\nion-item .applicant-info h2,\nion-item .applicant-info p {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.applicant-actions ion-button {\n  margin-left: 0.5rem;\n  --padding-end: 0;\n  --padding-start: 0;\n}\n.applicant-actions ion-button i {\n  font-size: 1.2em;\n}\n.applicant-actions a {\n  margin-left: 0.5rem;\n  color: var(--ion-color-primary);\n  font-size: 1.2em;\n  display: flex;\n  align-items: center;\n}\n/*# sourceMappingURL=applicant-list.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
var CaseListComponent = class _CaseListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonBadge, DatePipe], styles: ["\n\n.case-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.case-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%] {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.case-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(1) {\n  flex: 3;\n}\n.case-row[_ngcontent-%COMP%]   ion-badge[_ngcontent-%COMP%] {\n  flex: 0 0 80px;\n  text-align: center;\n}\n.case-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%] {\n  flex: 0 0 100px;\n  justify-content: flex-end;\n}\n.case-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%]   ion-button[_ngcontent-%COMP%] {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=case-list.css.map */"] });
};
(() => {
...
`, styles: ["/* src/app/admin/pages/case-list/case-list.css */\n.case-row {\n  display: flex;\n  align-items: center;\n}\n.case-row ion-label {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.case-row ion-label:nth-child(1) {\n  flex: 3;\n}\n.case-row ion-badge {\n  flex: 0 0 80px;\n  text-align: center;\n}\n.case-row ion-buttons {\n  flex: 0 0 100px;\n  justify-content: flex-end;\n}\n.case-row ion-buttons ion-button {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=case-list.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
var FraListComponent = class _FraListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem], styles: ["\n\n.fra-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.fra-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%] {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.fra-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(1) {\n  flex: 2;\n}\n.fra-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(2) {\n  flex: 2;\n}\n.fra-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(3) {\n  flex: 1.5;\n}\n.fra-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%] {\n  flex: 0 0 100px;\n  justify-content: flex-end;\n}\n.fra-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%]   ion-button[_ngcontent-%COMP%] {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=fra-list.css.map */"] });
};
(() => {
...
</ion-content>`, styles: ["/* src/app/admin/pages/fra-list/fra-list.css */\n.fra-row {\n  display: flex;\n  align-items: center;\n}\n.fra-row ion-label {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.fra-row ion-label:nth-child(1) {\n  flex: 2;\n}\n.fra-row ion-label:nth-child(2) {\n  flex: 2;\n}\n.fra-row ion-label:nth-child(3) {\n  flex: 1.5;\n}\n.fra-row ion-buttons {\n  flex: 0 0 100px;\n  justify-content: flex-end;\n}\n.fra-row ion-buttons ion-button {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=fra-list.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
var ReferralListComponent = class _ReferralListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem], styles: ["\n\n.referral-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.referral-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%] {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.referral-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(1) {\n  flex: 2;\n}\n.referral-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(2) {\n  flex: 2;\n}\n.referral-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(3) {\n  flex: 1.5;\n}\n.referral-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%] {\n  flex: 0 0 100px;\n  justify-content: flex-end;\n}\n.referral-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%]   ion-button[_ngcontent-%COMP%] {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=referral-list.css.map */"] });
};
(() => {
...
`, styles: ["/* src/app/admin/pages/referral-list/referral-list.css */\n.referral-row {\n  display: flex;\n  align-items: center;\n}\n.referral-row ion-label {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.referral-row ion-label:nth-child(1) {\n  flex: 2;\n}\n.referral-row ion-label:nth-child(2) {\n  flex: 2;\n}\n.referral-row ion-label:nth-child(3) {\n  flex: 1.5;\n}\n.referral-row ion-buttons {\n  flex: 0 0 100px;\n  justify-content: flex-end;\n}\n.referral-row ion-buttons ion-button {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=referral-list.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
var UserListComponent = class _UserListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListComponent, selectors: [["app-user-list"]], decls: 14, vars: 3, consts: [[1, "glass-toolbar"], ["slot", "start"], ["slot", "end"], [3, "click"], [1, "fa-solid", "fa-plus-circle"], [1, "ion-padding"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], ["class", "user-item-row", 4, "ngFor", "ngForOf"], [1, "user-item-row"], [1, "fa-solid", "fa-pen-to-square"], ["color", "danger", 3, "click", 4, "ngIf"], ["color", "danger", 3, "click"], [1, "fa-solid", "fa-trash"], [1, "ion-text-center"]], template: function UserListComponent_Template(rf, ctx) {
    ...
    IonCard,
    IonCardContent
  ], styles: ["\n\n.user-item-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  margin-bottom: 8px;\n}\n.user-item-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%] {\n  flex-grow: 1;\n  margin-right: 10px;\n}\n.user-item-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%], \n.user-item-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.user-item-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%] {\n  flex-shrink: 0;\n  display: flex;\n  align-items: center;\n}\n.user-item-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%]   ion-button[_ngcontent-%COMP%] {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=user-list.css.map */"] });
};
(() => {
...
var UserFormComponent = class _UserFormComponent {
  ...
  }, dependencies: [CommonModule, NgIf, FormsModule, \u0275NgNoValidate, NgControlStatus, NgControlStatusGroup, ReactiveFormsModule, FormGroupDirective, FormControlName, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonContent, IonItem, IonInput, IonSelect, IonSelectOption, IonButton, IonCard, IonCardContent], styles: ["\n\n/*# sourceMappingURL=user-form.css.map */"] });
};
(() => {
...
var AnnouncementListComponent = class _AnnouncementListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonToggle, SlicePipe, DatePipe], styles: ["\n\n.announcement-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.announcement-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%] {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.announcement-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(1) {\n  flex: 3;\n}\n.announcement-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(2) {\n  flex: 0 0 80px;\n  text-align: center;\n}\n.announcement-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(3), \n.announcement-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(4) {\n  flex: 1.5;\n}\n.announcement-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%] {\n  flex: 0 0 100px;\n  justify-content: flex-end;\n}\n.announcement-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%]   ion-button[_ngcontent-%COMP%] {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=announcement-list.component.css.map */"] });
};
(() => {
...
`, styles: ["/* src/app/admin/pages/announcement-list/announcement-list.component.css */\n.announcement-row {\n  display: flex;\n  align-items: center;\n}\n.announcement-row ion-label {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.announcement-row ion-label:nth-child(1) {\n  flex: 3;\n}\n.announcement-row ion-label:nth-child(2) {\n  flex: 0 0 80px;\n  text-align: center;\n}\n.announcement-row ion-label:nth-child(3),\n.announcement-row ion-label:nth-child(4) {\n  flex: 1.5;\n}\n.announcement-row ion-buttons {\n  flex: 0 0 100px;\n  justify-content: flex-end;\n}\n.announcement-row ion-buttons ion-button {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=announcement-list.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
var ApplicantComplaintsListComponent = class _ApplicantComplaintsListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonicModule, IonBadge2, IonButton2, IonButtons2, IonContent2, IonHeader2, IonItem2, IonItemDivider2, IonLabel2, IonList2, IonSearchbar2, IonSpinner2, IonTitle2, IonToolbar2, TextValueAccessorDirective, RouterLinkDelegateDirective], styles: ["\n\n.applicant-complaints-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.applicant-complaints-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%] {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.applicant-complaints-row[_ngcontent-%COMP%]   ion-label[_ngcontent-%COMP%]:nth-child(1) {\n  flex: 3;\n}\n.applicant-complaints-row[_ngcontent-%COMP%]   ion-badge[_ngcontent-%COMP%] {\n  flex: 0 0 100px;\n  text-align: center;\n}\n.applicant-complaints-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%] {\n  flex: 0 0 150px;\n  justify-content: flex-end;\n}\n.applicant-complaints-row[_ngcontent-%COMP%]   ion-buttons[_ngcontent-%COMP%]   ion-button[_ngcontent-%COMP%] {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=applicant-complaints-list.css.map */"] });
};
(() => {
...
`, styles: ["/* src/app/admin/pages/applicant-complaints-list/applicant-complaints-list.css */\n.applicant-complaints-row {\n  display: flex;\n  align-items: center;\n}\n.applicant-complaints-row ion-label {\n  flex: 1;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  padding-right: 10px;\n}\n.applicant-complaints-row ion-label:nth-child(1) {\n  flex: 3;\n}\n.applicant-complaints-row ion-badge {\n  flex: 0 0 100px;\n  text-align: center;\n}\n.applicant-complaints-row ion-buttons {\n  flex: 0 0 150px;\n  justify-content: flex-end;\n}\n.applicant-complaints-row ion-buttons ion-button {\n  --padding-start: 5px;\n  --padding-end: 5px;\n}\n/*# sourceMappingURL=applicant-complaints-list.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
//# sourceMappingURL=chunk-VQ2X6RVV.js.map
