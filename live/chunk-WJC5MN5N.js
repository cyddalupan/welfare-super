...
} from "./chunk-O5N76CT2.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-KVUZ5BUU.js";
import "./chunk-O2E5IOIP.js";
import {
  isRTL
} from "./chunk-HQELVUGY.js";
import {
  createLockController
} from "./chunk-772QYKXX.js";
import "./chunk-55S3R7SR.js";
import {
  getTimeGivenProgression
} from "./chunk-AXOFHZOB.js";
import {
  transition
} from "./chunk-VQNBKA3N.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-TZLVID7F.js";
import {
  createColorClasses,
  hostContext
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-G4UZ5ZXQ.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-GGD62NHC.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-VJBGHIKE.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./chunk-S73LME3B.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-PYCNXNZW.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-ALSETTVW.js").then((module) => this.focusVisible = module.startFocusVisible());
      });
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./chunk-DE3TCZQW.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
