...
function CaseListComponent_tr_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 13)(1, "td", 14);
    \u0275\u0275text(2);
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td", 14)(6, "span", 15);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(10, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 16)(12, "a", 17);
    \u0275\u0275text(13, "Edit");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "button", 18);
    \u0275\u0275listener("click", function CaseListComponent_tr_23_Template_button_click_14_listener() {
      const caseItem_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.deleteCase(caseItem_r2.id));
    });
    \u0275\u0275text(15, "Delete");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const caseItem_r2 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(caseItem_r2.employee_name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(caseItem_r2.category);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(9, _c02, caseItem_r2.report_status === "open", caseItem_r2.report_status === "closed"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", caseItem_r2.report_status, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(10, 6, caseItem_r2.date_reported, "shortDate"));
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(12, _c12, caseItem_r2.id));
  }
}
function CaseListComponent_tr_24_Template(rf, ctx) {
  if (rf & 1) {
...
var CaseListComponent = class _CaseListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CaseListComponent, selectors: [["app-case-list"]], decls: 25, vars: 3, consts: [[1, "glass-card", "p-8", "text-white", "rounded-xl"], [1, "flex", "justify-between", "items-center", "mb-6"], [1, "text-3xl", "font-bold"], ["routerLink", "/admin/cases/new", 1, "bg-blue-600", "hover:bg-blue-700", "text-white", "font-bold", "py-2", "px-4", "rounded-md", "transition", "duration-300"], [1, "mb-4"], ["type", "text", "placeholder", "Search cases...", 1, "w-full", "px-4", "py-2", "bg-white/20", "rounded-md", "border", "border-transparent", "focus:outline-none", "focus:ring-2", "focus:ring-blue-500", "text-gray-800", 3, "ngModelChange", "ngModel"], [1, "overflow-x-auto", "bg-black/30", "backdrop-blur-xl", "rounded-lg", "shadow-lg"], [1, "min-w-full"], [1, "border-b", "border-white/20"], [1, "px-6", "py-3", "text-left", "text-sm", "font-medium", "uppercase", "tracking-wider", "cursor-pointer", 3, "click"], [1, "px-6", "py-3", "text-right", "text-sm", "font-medium", "uppercase", "tracking-wider"], ["class", "border-b border-white/10 hover:bg-white/5", 4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "border-b", "border-white/10", "hover:bg-white/5"], [1, "px-6", "py-4", "whitespace-nowrap"], [1, "px-2", "inline-flex", "text-xs", "leading-5", "font-semibold", "rounded-full", 3, "ngClass"], [1, "px-6", "py-4", "whitespace-nowrap", "text-right", "text-sm", "font-medium"], [1, "text-indigo-400", "hover:text-indigo-300", "mr-4", 3, "routerLink"], [1, "text-red-400", "hover:text-red-300", 3, "click"], ["colspan", "5", 1, "text-center", "py-8"]], template: function CaseListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h1", 2);
      \u0275\u0275text(3, "Cases");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(8, "div", 6)(9, "table", 7)(10, "thead")(11, "tr", 8)(12, "th", 9);
      \u0275\u0275listener("click", function CaseListComponent_Template_th_click_12_listener() {
        return ctx.sort("employee_name");
      });
      \u0275\u0275text(13, " Employee ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "th", 9);
      \u0275\u0275listener("click", function CaseListComponent_Template_th_click_14_listener() {
        return ctx.sort("category");
      });
      \u0275\u0275text(15, " Category ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "th", 9);
      \u0275\u0275listener("click", function CaseListComponent_Template_th_click_16_listener() {
        return ctx.sort("report_status");
      });
      \u0275\u0275text(17, " Status ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "th", 9);
      \u0275\u0275listener("click", function CaseListComponent_Template_th_click_18_listener() {
        return ctx.sort("date_reported");
      });
      \u0275\u0275text(19, " Date Reported ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "th", 10);
      \u0275\u0275text(21, " Actions ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(22, "tbody");
      \u0275\u0275template(23, CaseListComponent_tr_23_Template, 16, 14, "tr", 11)(24, CaseListComponent_tr_24_Template, 3, 0, "tr", 12);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      \u0275\u0275twoWayProperty("ngModel", ctx.searchTerm);
      \u0275\u0275advance(16);
      \u0275\u0275property("ngForOf", ctx.filteredCases);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.filteredCases || ctx.filteredCases.length === 0);
    }
...
function CaseFormComponent_option_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngValue", emp_r1.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate3(" ", emp_r1.last_name, ", ", emp_r1.first_name, " (", emp_r1.passport_number, ") ");
  }
}
var CaseFormComponent = class _CaseFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CaseFormComponent, selectors: [["app-case-form"]], decls: 38, vars: 9, consts: [[1, "glass-card", "p-8", "text-white", "rounded-xl"], [1, "text-3xl", "font-bold", "mb-6"], [1, "space-y-4", 3, "ngSubmit"], ["for", "employee_id", 1, "block", "text-sm", "font-medium", "text-gray-300"], ["id", "employee_id", "name", "employee_id", "required", "", 1, "mt-1", "block", "w-full", "px-3", "py-2", "bg-white/20", "border", "border-transparent", "rounded-md", "shadow-sm", "focus:outline-none", "focus:ring-blue-500", "focus:border-blue-500", "sm:text-sm", "text-gray-800", 3, "ngModelChange", "ngModel"], ["disabled", "", 3, "ngValue"], [3, "ngValue", 4, "ngFor", "ngForOf"], ["for", "category", 1, "block", "text-sm", "font-medium", "text-gray-300"], ["type", "text", "id", "category", "name", "category", "required", "", 1, "mt-1", "block", "w-full", "px-3", "py-2", "bg-white/20", "border", "border-transparent", "rounded-md", "shadow-sm", "focus:outline-none", "focus:ring-blue-500", "focus:border-blue-500", "sm:text-sm", "text-gray-800", 3, "ngModelChange", "ngModel"], ["for", "report", 1, "block", "text-sm", "font-medium", "text-gray-300"], ["id", "report", "name", "report", "rows", "5", "required", "", 1, "mt-1", "block", "w-full", "px-3", "py-2", "bg-white/20", "border", "border-transparent", "rounded-md", "shadow-sm", "focus:outline-none", "focus:ring-blue-500", "focus:border-blue-500", "sm:text-sm", "text-gray-800", 3, "ngModelChange", "ngModel"], ["for", "report_status", 1, "block", "text-sm", "font-medium", "text-gray-300"], ["id", "report_status", "name", "report_status", "required", "", 1, "mt-1", "block", "w-full", "px-3", "py-2", "bg-white/20", "border", "border-transparent", "rounded-md", "shadow-sm", "focus:outline-none", "focus:ring-blue-500", "focus:border-blue-500", "sm:text-sm", "text-gray-800", 3, "ngModelChange", "ngModel"], ["value", "open"], ["value", "closed"], ["value", "pending"], ["for", "agency_id", 1, "block", "text-sm", "font-medium", "text-gray-300"], ["type", "number", "id", "agency_id", "name", "agency_id", 1, "mt-1", "block", "w-full", "px-3", "py-2", "bg-white/20", "border", "border-transparent", "rounded-md", "shadow-sm", "focus:outline-none", "focus:ring-blue-500", "focus:border-blue-500", "sm:text-sm", "text-gray-800", 3, "ngModelChange", "ngModel"], [1, "flex", "justify-end", "space-x-3"], ["type", "button", 1, "px-4", "py-2", "border", "border-gray-300", "rounded-md", "shadow-sm", "text-sm", "font-medium", "text-gray-700", "bg-white", "hover:bg-gray-50", "focus:outline-none", "focus:ring-2", "focus:ring-offset-2", "focus:ring-indigo-500", 3, "click"], ["type", "submit", 1, "inline-flex", "justify-center", "py-2", "px-4", "border", "border-transparent", "shadow-sm", "text-sm", "font-medium", "rounded-md", "text-white", "bg-blue-600", "hover:bg-blue-700", "focus:outline-none", "focus:ring-2", "focus:ring-offset-2", "focus:ring-blue-500"], [3, "ngValue"]], template: function CaseFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function CaseFormComponent_Template_select_ngModelChange_7_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.caseItem.employee_id, $event) || (ctx.caseItem.employee_id = $event);
        return $event;
      });
      \u0275\u0275elementStart(8, "option", 5);
      \u0275\u0275text(9, "Select an Employee");
      \u0275\u0275elementEnd();
      \u0275\u0275template(10, CaseFormComponent_option_10_Template, 2, 4, "option", 6);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(11, "div")(12, "label", 7);
      \u0275\u0275text(13, "Category");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "input", 8);
      \u0275\u0275twoWayListener("ngModelChange", function CaseFormComponent_Template_input_ngModelChange_14_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.caseItem.category, $event) || (ctx.caseItem.category = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275twoWayListener("ngModelChange", function CaseFormComponent_Template_textarea_ngModelChange_18_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.caseItem.report, $event) || (ctx.caseItem.report = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275twoWayListener("ngModelChange", function CaseFormComponent_Template_select_ngModelChange_22_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.caseItem.report_status, $event) || (ctx.caseItem.report_status = $event);
        return $event;
      });
      ...
      \u0275\u0275text(31, "Agency ID (Optional)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "input", 17);
      \u0275\u0275twoWayListener("ngModelChange", function CaseFormComponent_Template_input_ngModelChange_32_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.caseItem.agency_id, $event) || (ctx.caseItem.agency_id = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(33, "div", 18)(34, "button", 19);
      \u0275\u0275listener("click", function CaseFormComponent_Template_button_click_34_listener() {
        return ctx.router.navigate(["/admin/cases"]);
      });
      \u0275\u0275text(35, " Cancel ");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275twoWayProperty("ngModel", ctx.caseItem.employee_id);
      \u0275\u0275advance();
      \u0275\u0275property("ngValue", null);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.employees);
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.caseItem.category);
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.caseItem.report);
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.caseItem.report_status);
      \u0275\u0275advance(10);
      \u0275\u0275twoWayProperty("ngModel", ctx.caseItem.agency_id);
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", ctx.isEditMode ? "Update Case" : "Create Case", " ");
    }
  }, dependencies: [CommonModule, NgForOf, FormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, NumberValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm], styles: ["\n\n/*# sourceMappingURL=case-form.css.map */"] });
};
(() => {
  ...
  <form (ngSubmit)="saveCase()" class="space-y-4">
    <div>
...
//# sourceMappingURL=chunk-TJR4JI2T.js.map
