...
var ApplicantService = class _ApplicantService {
  ...
  async getStatuses() {
    ...
    if (res && res.data && Array.isArray(res.data)) {
      return res.data.map((item) => item.main_status);
    }
    return [];
  }
...
function SidebarComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15)(1, "ul")(2, "li", 16)(3, "a", 17);
    \u0275\u0275text(4, " All Applicants ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(5, SidebarComponent_div_15_li_5_Template, 4, 6, "li", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 24, vars: 3, consts: [[1, "w-64", "glass-card", "p-6", "flex", "flex-col", "text-white", "rounded-xl"], [1, "text-2xl", "font-bold", "mb-10", "text-center"], [1, "mb-4"], ["routerLink", "/admin/dashboard", "routerLinkActive", "bg-white/20", 1, "flex", "items-center", "p-3", "rounded-lg", "hover:bg-white/10", "transition-colors", "duration-200"], [1, "fas", "fa-tachometer-alt", "w-6", "h-6", "mr-3"], [1, "w-full", "flex", "items-center", "justify-between", "p-3", "rounded-lg", "hover:bg-white/10", "transition-colors", "duration-200", 3, "click"], [1, "flex", "items-center"], [1, "fas", "fa-users", "w-6", "h-6", "mr-3"], [1, "fas", "fa-chevron-down", "w-4", "h-4", "transition-transform", "duration-200"], ["class", "mt-2 ml-4 pl-3 border-l-2 border-white/20", 4, "ngIf"], ["routerLink", "/admin/cases", "routerLinkActive", "bg-white/20", 1, "flex", "items-center", "p-3", "rounded-lg", "hover:bg-white/10", "transition-colors", "duration-200"], [1, "fas", "fa-folder-open", "w-6", "h-6", "mr-3"], [1, "mt-auto"], [1, "w-full", "flex", "items-center", "justify-center", "p-3", "rounded-lg", "bg-red-600/80", "hover:bg-red-700/60", "transition-colors", "duration-200", 3, "click"], [1, "fas", "fa-sign-out-alt", "w-6", "h-6", "mr-3"], [1, "mt-2", "ml-4", "pl-3", "border-l-2", "border-white/20"], [1, "mb-2"], ["routerLink", "/admin/applicants", "routerLinkActive", "bg-white/20", 1, "block", "p-2", "rounded-lg", "hover:bg-white/10", "transition-colors", "duration-200", 3, "routerLinkActiveOptions"], ["class", "mb-2", 4, "ngFor", "ngForOf"], ["routerLinkActive", "bg-white/20", 1, "block", "p-2", "rounded-lg", "hover:bg-white/10", "transition-colors", "duration-200", 3, "routerLink"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
...
function ApplicantFormComponent_form_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ApplicantFormComponent_form_4_Template_select_ngModelChange_131_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function ApplicantFormComponent_form_4_Template_input_ngModelChange_139_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const applicantForm_r3 = \u0275\u0275reference(1);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(9);
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("disabled", !applicantForm_r3.form.valid);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApplicantFormComponent, { className: "ApplicantFormComponent", filePath: "src/app/admin/components/applicant-form/applicant-form.ts", lineNumber: 15 });
})();
...
var _c04 = (a0) => ["/admin/fra/edit", a0];
function FraListComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275text(1, "Loading FRAs...");
    \u0275\u0275elementEnd();
  }
}
function FraListComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7);
    \u0275\u0275text(1, " No FRAs found. ");
    \u0275\u0275elementEnd();
  }
}
function FraListComponent_div_9_tr_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td", 16)(10, "a", 17);
    \u0275\u0275text(11, "Edit");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "button", 18);
    \u0275\u0275listener("click", function FraListComponent_div_9_tr_15_Template_button_click_12_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(fra_r4.address);
    \u0275\u0275advance(2);
...
function FraListComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function FraListComponent_div_9_Template_th_click_8_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sort("address"));
    });
    \u0275\u0275text(9, " Address ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "th", 11);
    \u0275\u0275listener("click", function FraListComponent_div_9_Template_th_click_10_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sort("country"));
    });
    ...
    \u0275\u0275template(15, FraListComponent_div_9_tr_15_Template, 14, 7, "tr", 14);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var FraListComponent = class _FraListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FraListComponent, selectors: [["app-fra-list"]], decls: 10, vars: 4, consts: [[1, "container", "mx-auto", "p-4"], [1, "text-2xl", "font-bold", "mb-4"], [1, "flex", "justify-between", "items-center", "mb-4"], ["type", "text", "placeholder", "Search FRAs...", 1, "p-2", "border", "rounded", "w-1/3", 3, "ngModelChange", "input", "ngModel"], ["routerLink", "/admin/fra/new", 1, "bg-blue-500", "text-white", "px-4", "py-2", "rounded", "hover:bg-blue-600"], ["class", "text-center py-4", 4, "ngIf"], ["class", "bg-white shadow-md rounded-lg overflow-hidden", 4, "ngIf"], [1, "text-center", "py-4"], [1, "bg-white", "shadow-md", "rounded-lg", "overflow-hidden"], [1, "min-w-full", "divide-y", "divide-gray-200"], [1, "bg-gray-50"], [1, "px-6", "py-3", "text-left", "text-xs", "font-medium", "text-gray-500", "uppercase", "tracking-wider", "cursor-pointer", 3, "click"], [1, "px-6", "py-3", "text-left", "text-xs", "font-medium", "text-gray-500", "uppercase", "tracking-wider"], [1, "bg-white", "divide-y", "divide-gray-200"], [4, "ngFor", "ngForOf"], [1, "px-6", "py-4", "whitespace-nowrap"], [1, "px-6", "py-4", "whitespace-nowrap", "text-sm", "font-medium"], [1, "text-indigo-600", "hover:text-indigo-900", "mr-4", 3, "routerLink"], [1, "text-red-600", "hover:text-red-900", 3, "click"]], template: function FraListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "h2", 1);
      \u0275\u0275text(2, "Foreign Recruitment Agencies");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 2)(4, "input", 3);
      \u0275\u0275twoWayListener("ngModelChange", function FraListComponent_Template_input_ngModelChange_4_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchTerm, $event) || (ctx.searchTerm = $event);
        return $event;
      });
      \u0275\u0275listener("input", function FraListComponent_Template_input_input_4_listener() {
        return ctx.filterFras();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "a", 4);
      \u0275\u0275text(6, "Add New FRA");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(7, FraListComponent_div_7_Template, 2, 0, "div", 5)(8, FraListComponent_div_8_Template, 2, 0, "div", 5)(9, FraListComponent_div_9_Template, 16, 1, "div", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      ...
      \u0275\u0275property("ngIf", ctx.isLoading);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.isLoading && ctx.filteredFras.length === 0);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.isLoading && ctx.filteredFras.length > 0);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FraListComponent, [{
    type: Component,
    args: [{ selector: "app-fra-list", standalone: true, imports: [CommonModule, FormsModule, RouterModule], template: `<div class="container mx-auto p-4">
  <h2 class="text-2xl font-bold mb-4">Foreign Recruitment Agencies</h2>
  ...
  <div class="flex justify-between items-center mb-4">
    <input
      ...
      [(ngModel)]="searchTerm"
      (input)="filterFras()"
      placeholder="Search FRAs..."
      class="p-2 border rounded w-1/3"
    />
    <a routerLink="/admin/fra/new" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add New FRA</a>
  </div>

  <div *ngIf="isLoading" class="text-center py-4">Loading FRAs...</div>

  <div *ngIf="!isLoading && filteredFras.length === 0" class="text-center py-4">
    No FRAs found.
  </div>

  <div *ngIf="!isLoading && filteredFras.length > 0" class="bg-white shadow-md rounded-lg overflow-hidden">
    <table class="min-w-full divide-y divide-gray-200">
      <thead class="bg-gray-50">
        <tr>
          ...
          <th (click)="sort('contact')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer">
            Contact
          </th>
          <th (click)="sort('address')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer">
            Address
          </th>
          <th (click)="sort('country')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer">
            Country
          </th>
      ...
      <tbody class="bg-white divide-y divide-gray-200">
        <tr *ngFor="let fra of filteredFras">
          <td class="px-6 py-4 whitespace-nowrap">{{ fra.name }}</td>
          <td class="px-6 py-4 whitespace-nowrap">{{ fra.contact }}</td>
          <td class="px-6 py-4 whitespace-nowrap">{{ fra.address }}</td>
          <td class="px-6 py-4 whitespace-nowrap">{{ fra.country }}</td>
          <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
            <a [routerLink]="['/admin/fra/edit', fra.id]" class="text-indigo-600 hover:text-indigo-900 mr-4">Edit</a>
            <button (click)="deleteFra(fra.id)" class="text-red-600 hover:text-red-900">Delete</button>
          </td>
        </tr>
      </tbody>
    </table>
...
//# sourceMappingURL=chunk-BEVQ7XIT.js.map
