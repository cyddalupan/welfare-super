...
function SidebarComponent_ion_list_14_ion_menu_toggle_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-menu-toggle", 0)(1, "ion-item", 18);
...
function SidebarComponent_ion_list_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-list")(1, "ion-menu-toggle", 0)(2, "ion-item", 15);
    \u0275\u0275element(3, "ion-icon", 16);
    \u0275\u0275elementStart(4, "ion-label");
    \u0275\u0275text(5, "All Applicants");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(6, SidebarComponent_ion_list_14_ion_menu_toggle_6_Template, 6, 6, "ion-menu-toggle", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 35, vars: 2, consts: [["autoHide", "false"], ["routerLink", "/admin/dashboard", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "apps"], ["button", "", 3, "click"], ["slot", "start", "name", "people"], ["slot", "end", 3, "name"], [4, "ngIf"], ["routerLink", "/admin/cases", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "folder-open"], ["routerLink", "/admin/fras", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "business"], ["routerLink", "/admin/users", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "people-circle-outline"], ["expand", "full", "color", "danger", 3, "click"], ["slot", "start", "name", "log-out"], ["routerLink", "/admin/applicants", "routerLinkActive", "selected", "routerDirection", "root", "detail", "false"], ["slot", "start", "name", "list"], ["autoHide", "false", 4, "ngFor", "ngForOf"], ["routerLinkActive", "selected", "routerDirection", "root", "detail", "false", 3, "routerLink"], ["slot", "start", "name", "person"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(29, "Admin Users");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(30, "ion-footer")(31, "ion-toolbar")(32, "ion-button", 13);
      \u0275\u0275listener("click", function SidebarComponent_Template_ion_button_click_32_listener() {
        return ctx.logout();
      });
...
function UserListComponent_ion_list_12_ion_item_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "ion-buttons", 1)(7, "ion-button", 10);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, UserListComponent_ion_list_12_ion_item_1_ion_button_9_Template, 2, 0, "ion-button", 12);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function UserListComponent_ion_card_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-card")(1, "ion-card-content")(2, "p", 15);
...
var UserListComponent = class _UserListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserListComponent, selectors: [["app-user-list"]], decls: 14, vars: 3, consts: [["slot", "start"], ["slot", "end"], ["routerLink", "/admin/users/new"], ["name", "add-circle-outline"], [1, "ion-padding"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [4, "ngFor", "ngForOf"], [3, "click"], ["name", "create-outline"], ["color", "danger", 3, "click", 4, "ngIf"], ["color", "danger", 3, "click"], ["name", "trash-outline"], [1, "ion-text-center"]], template: function UserListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-buttons", 0);
...
var ADMIN_ROUTES = [
  ...
  },
  {
    ...
    children: [
      ...
      // New route for user listing
      { path: "users/new", component: UserFormComponent },
      // New route for creating user
      { path: "users/edit/:id", component: UserFormComponent },
      // New route for editing user
...
var AdminModule = class _AdminModule {
  ...
  static \u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
    AdminUsersService
    // Provide AdminUsersService here
  ], imports: [
    CommonModule,
    FormsModule,
    IonicModule,
    ...
    SidebarComponent,
    UserListComponent,
    // Add UserListComponent here
    UserFormComponent
    // Add UserFormComponent here
  ] });
};
(() => {
...
//# sourceMappingURL=chunk-VYMEY4HA.js.map
