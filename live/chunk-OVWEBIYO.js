...
function FraFormComponent_form_4_option_83_Template(rf, ctx) {
  if (rf & 1) {
...
function FraFormComponent_form_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function FraFormComponent_form_4_Template_select_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "option", 34);
    \u0275\u0275text(56, "Qatar");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "option", 35);
    \u0275\u0275text(58, "Kuwait");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(64, "Egypt");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "option", 39);
    \u0275\u0275text(66, "Jordan");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "option", 40);
    \u0275\u0275text(68, "Lebanon");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "option", 41);
    \u0275\u0275text(70, "Iraq");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "option", 42);
    \u0275\u0275text(72, "Iran");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(76, "Israel");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(77, "div", 6)(78, "label", 45);
    \u0275\u0275text(79, "Applicant:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "select", 46);
    \u0275\u0275twoWayListener("ngModelChange", function FraFormComponent_form_4_Template_select_ngModelChange_80_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(82, "Select Applicant");
    \u0275\u0275elementEnd();
    \u0275\u0275template(83, FraFormComponent_form_4_option_83_Template, 2, 3, "option", 48);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(84, "div", 6)(85, "label", 49);
    \u0275\u0275text(86, "Agency ID:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "input", 50);
    \u0275\u0275twoWayListener("ngModelChange", function FraFormComponent_form_4_Template_input_ngModelChange_87_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(88, "div", 51)(89, "button", 52);
    \u0275\u0275text(90);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "button", 53);
    \u0275\u0275listener("click", function FraFormComponent_form_4_Template_button_click_91_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
var FraFormComponent = class _FraFormComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, NumberValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, RouterModule], encapsulation: 2 });
};
(() => {
  ...
  <form *ngIf="!isLoading" (ngSubmit)="saveFra()" class="bg-white shadow-md rounded-lg p-6">
    ...
    <div class="mb-4">
      <label for="applicant_id" class="block text-gray-700 text-sm font-bold mb-2">Applicant:</label>
      <select
        id="applicant_id"
        name="applicant_id"
        [(ngModel)]="fra.applicant_id"
        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
      >
        <option [ngValue]="null">Select Applicant</option>
...
//# sourceMappingURL=chunk-OVWEBIYO.js.map
