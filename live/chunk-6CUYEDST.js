...
import {
  transition
} from "./chunk-WFMQ6FSS.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-ZNVIAQR7.js";
import {
  createColorClasses,
  hostContext
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-Q7RMARK2.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-M7WDLQU2.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-XW6E4ZBS.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./chunk-SDKWBYUG.js");
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./chunk-QR5GXMIE.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6CUYEDST.js.map
