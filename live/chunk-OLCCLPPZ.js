    ...
    try {
      ...
      if (result && result.data && result.data.length > 0) {
        ...
        if (user.password === password) {
          ...
          console.log("AuthService: Login successful, returning true");
          return true;
        }
      }
      console.log("AuthService: Login failed (invalid credentials or no user data), returning false");
      return false;
    } catch (error) {
...
//# sourceMappingURL=chunk-OLCCLPPZ.js.map
