...
var SidebarComponent = class _SidebarComponent {
  ...
  }, dependencies: [RouterModule, RouterLink, RouterLinkActive, CommonModule, NgForOf, NgIf, IonList, IonListHeader, IonLabel, IonMenuToggle, IonItem, IonIcon, IonFooter, IonToolbar, IonButton, TitleCasePipe], encapsulation: 2 });
};
(() => {
...
var ApplicantListComponent = class _ApplicantListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonBadge], encapsulation: 2 });
};
(() => {
...
var FraListComponent = class _FraListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem], encapsulation: 2 });
};
(() => {
...
var AnnouncementListComponent = class _AnnouncementListComponent {
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonHeader, IonToolbar, IonTitle, IonButtons, IonButton, IonIcon, IonContent, IonSearchbar, IonSpinner, IonList, IonItemDivider, IonLabel, IonItem, IonToggle, SlicePipe, DatePipe], encapsulation: 2 });
};
(() => {
...
var ApplicantComplaintsListComponent = class _ApplicantComplaintsListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ApplicantComplaintsListComponent, selectors: [["app-applicant-complaints-list"]], decls: 8, vars: 3, consts: [["placeholder", "Search applicants...", 3, "ngModelChange", "ionChange", "ngModel"], ["class", "ion-padding ion-text-center", 4, "ngIf"], [4, "ngIf"], [1, "ion-padding", "ion-text-center"], ["name", "crescent"], [3, "click"], ["name", "swap-vertical-outline"], [1, "ion-text-right"], [4, "ngFor", "ngForOf"], ["slot", "end", 3, "color"], ["slot", "end"], ["fill", "clear", 3, "routerLink"], ["name", "create-outline"], ["fill", "clear", "color", "danger", 3, "click", 4, "ngIf"], ["fill", "clear", "color", "primary", 3, "routerLink", 4, "ngIf"], ["target", "_blank", "rel", "noopener noreferrer", 3, "href"], ["name", "document-text-outline"], ["fill", "clear", "color", "danger", 3, "click"], ["name", "trash-outline"], ["fill", "clear", "color", "primary", 3, "routerLink"], ["name", "chatbubbles-outline"], [1, "ion-text-center"]], template: function ApplicantComplaintsListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-title");
  ...
  }, dependencies: [CommonModule, NgForOf, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, RouterLink, IonicModule, IonBadge2, IonButton2, IonButtons2, IonContent2, IonHeader2, IonIcon2, IonItem2, IonItemDivider2, IonLabel2, IonList2, IonSearchbar2, IonSpinner2, IonTitle2, IonToolbar2, TextValueAccessorDirective, RouterLinkDelegateDirective], encapsulation: 2 });
};
(() => {
...
//# sourceMappingURL=chunk-MNH6EHWS.js.map
