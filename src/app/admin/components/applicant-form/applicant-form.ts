...
import { IonContent, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonGrid, IonRow, IonCol, IonCard, IonCardContent, IonSpinner, IonCardTitle, IonList, IonItem, IonInput, IonSelect, IonSelectOption, IonTextarea, IonButton, IonLabel } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, ReactiveFormsModule, IonContent, IonHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonGrid, IonRow, IonCol, IonCard, IonCardContent, IonSpinner, IonCardTitle, IonList, IonItem, IonInput, IonSelect, IonSelectOption, IonTextarea, IonButton, IonLabel],
